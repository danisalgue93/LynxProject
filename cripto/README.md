...
- **Duelos, staking y DAO:** todavía **custodial**, gestionados por el backend (`backend/`) en un balance interno. Esto es una decisión de alcance temporal, no un descuido — ver `LAUNCH_DECISIONS.md` ("phase 5") para el plan de migración pendiente.
