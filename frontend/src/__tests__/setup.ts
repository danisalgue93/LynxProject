...
// media queries don't throw during test rendering. Guarded because pure-logic
// suites run in the node environment (via `// @vitest-environment node`), where
// there is no window and this setup file still loads.
