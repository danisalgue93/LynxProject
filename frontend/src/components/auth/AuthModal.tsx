        ...
        <div className="p-8">
          <div className="text-center mb-8">
            <h2 className="text-xl md:text-2xl font-bold text-white mb-2">
              {t("common.authModalTitle", "Connect Your Wallet")}
            </h2>
            <p className="text-xs text-[#A1A1AA]">
              {t(
                "common.authModalDescription",
                "Create an account or log in to start trading and managing your portfolio.",
              )}
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            >
              ...
              {t("common.continueWithWallet", "Connect External Wallet")}
            </button>
          </div>
        </div>
      </div>
