    ...
    <div className="p-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div key={i} className="glass-card rounded p-4 border border-[#00FFD1]/20 bg-[#00FFD1]/5 flex flex-col sm:flex-row sm:items-center justify-between gap-4 transition-all">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-2">
                        <span className="text-[9px] font-bold text-black bg-[#00FFD1] px-1.5 py-0.5 rounded tracking-tighter uppercase">{t('portfolio.won', 'Won')}</span>
        ...
        <div className="lg:col-span-1">
          <h3 className="text-[11px] font-bold text-[#71717A] uppercase tracking-widest mb-6">{t('portfolio.yieldHub', '$LYNX Yield Hub')}</h3>
